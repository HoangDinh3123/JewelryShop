            ...
            <v-card-text>
                <v-container>
                    <v-form enctype='multipart/form-data'>
                        ...
                        <v-col cols="12" >
                            <v-row>
                                <v-col md="3" v-for="(file, index) in files" :key="index">
...
export default {
    ...
    methods: {
        ...mapActions(['getCategories', 'updateJewelry']),
        getImageUrl(file) {
            if (file) {
        ...
        update(){
            ...
            formData.append('jewelryId', this.jewelry.jewelryId);
    ...
    watch:{
        currentItem:function(){
            this.jewelry.jewelryId = this.currentItem.jewelryId;
            this.jewelry.jewelryName = this.currentItem.jewelryName;
            this.jewelry.jewelryDescription = this.currentItem.jewelryDescription;
            this.jewelry.jewelryWeight = this.currentItem.jewelryWeight;
            this.jewelry.jewelrySize = this.currentItem.jewelrySize;
            this.jewelry.jewelryPrice = this.currentItem.jewelryPrice;
            this.jewelry.jewelryColor = this.currentItem.jewelryColor;
            this.jewelry.categoryId = this.currentItem.categoryId;
            this.files = this.currentItem.jewelryImages;
        }
      }
}
</script>
